...
int main()	// Main function
{
	...
	do
	{
		...
		case 2:
			{
				orderss.delete_order();	//function delete
				system("PAUSE");
				break;
			}	//end case 2
		...
		case 3:
			{
				orderss.modify();	//function modify
				system("PAUSE");
				break;
			}	//end case 3
		...
		case 4:
			{
				bills.order_list();	//function order
				system("PAUSE");
				break;
			}	//end case 4
		case 5:
			{
				sum.daily_summary();	//function daily_summary
				system("PAUSE");
				break;
			}	//end case 5
        case 6:
			{
				leaving.exit();	//function exit
				goto a;
				break;
			}	//end case 6
